...
export default function MicrophoneComponent({ onTranscriptionFinished } : {
    onTranscriptionFinished? : (transcription : string) => void
}) {
  ...
  const stopRecording = () => {
    if (recognitionRef.current) {
      ...
      onTranscriptionFinished?.call({}, transcript);
    }
  };
